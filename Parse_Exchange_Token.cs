...
namespace Parser3
{
    ...
    public partial class ExchangeToken
    {
        public static ExchangeToken FromJson(string json) => JsonConvert.DeserializeObject<ExchangeToken>(json, Parser3.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this ExchangeToken self) => JsonConvert.SerializeObject(self, Parser3.Converter.Settings);
    }
